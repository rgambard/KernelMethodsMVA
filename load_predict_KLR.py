...
#load model
alpha_x0 = np.load('alphaLR_x0.npy')
print(alpha_x0)
x_train_x0 = np.load('x_train_x0.npy')

alpha_x1 = np.load('alphaLR_x1.npy')
print(alpha_x1)
x_train_x1 = np.load('x_train_x1.npy')

alpha_x2 = np.load('alphaLR_x2.npy')
print(alpha_x2)
x_train_x2 = np.load('x_train_x2.npy')
